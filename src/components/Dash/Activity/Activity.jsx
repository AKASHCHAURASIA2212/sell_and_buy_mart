        ...
        <div className=''>
            <div className="grid grid-cols-1 gap-5 bg-gray-100 p-2 sm:grid-cols-2 sm:p-10 lg:grid-cols-3">
                ...
                <div className="max-w-md rounded-xl border bg-white p-6 pb-10 text-gray-900">
                    ...
                    <div className="flex items-center py-2">
                        <img className="h-10 w-10 rounded-full object-cover" src="/images/fR71TFZIDTv2jhvKsOMhC.png" alt="" />
                        <p className="ml-4 w-56">
                    ...
                    <div className="flex items-center py-2">
                        <img className="h-10 w-10 rounded-full object-cover" src="/images/R-Wx_NHvZBci3KLrgXhp1.png" alt="" />
                        <p className="ml-4 w-56">
